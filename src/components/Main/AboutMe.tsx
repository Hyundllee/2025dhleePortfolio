				...
				<div className="aboutMe_con">
					...
					<div className="aboutText">
						...
						<div className="textBox">
							...
							<p>
								UI 개발자로서 4년10개월 동안 다수의 공공·금융·이커머스 등 <br />
								다양한 프로젝트를 수행해왔습니다. 여러 개발 환경에서 쌓은 경험을 바탕으로,
								<br />
								어떤 조직과 프로젝트에서도 빠르게 적응할 수 있는 유연함을 갖추고 있습니다.
							</p>
							<p>
						...
						<a href="/assets/resume_donghyunlee.docx" className="aboutMore" download>
							<span>이력서 다운로드</span>
						</a>
						{/* <a
