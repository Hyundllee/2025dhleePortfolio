...
const Portfolio: React.FC<PortfolioProps> = ({ portfolioList }) => {
  useEffect(() => {
    const portfolioItems = document.querySelectorAll<HTMLLIElement>(
      ".portfolioList ul li:nth-child(2n)"
    )
        ...
        <div className="portWrap">
          <div className="porfolioText">
            ...
            <p>
              ...
              안정적인 코드를 위해 지속적으로 고민하고 개선해 왔습니다. <br />이
              포트폴리오는 그 과정 속에서 성장한 결과물들입니다.
            </p>
          </div>
