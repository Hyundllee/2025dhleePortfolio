		...
		<div className="modalContent">
			...
			<div className="introText">
				<p>
					...
					때문에 우리가 외부에서 정말 손쉽게 구할 수 있는 정보, 검색, 다양한 웹 브라우저 , 라이브러리 ,
					프레임워크 등 내부로의
					<br className="mob-hidden" />
					반입이 제한이 걸립니다. 정말 필요한 경우의 문서 및 파일의 경우 철저한 절차를 통하여 내부로의 반입이
					이루어지는데 '오픈소스관리포털'은 이를 좀 더 체계적이면서 효울적으로 절차를 진행하고자 취지에서
					만들어진 내부 시스템입니다.
				</p>
			</div>
				...
				<ul className="listStyle1">
					<li>
						...
						<ul className="listStyle2">
							<li>
								프로젝트 전 페이지의 화면 설계 및 UI 구현을 단독으로 담당하여 초기 구조 설계부터
								컴포넌트 개발<br></br> 유지보수 체계 구축까지 전체 화면 개발을 주도적으로 수행했습니다.
							</li>
						</ul>
					</li>
					<li>
						...
						<ul className="listStyle2">
							<li>
								<p>
									반복 작업을 최대한 줄이기 위해서 버튼,팝업,검색영역 등 최소한의 컴포넌트 형태로
									컴포넌트 설계
								</p>
							</li>
							<li>
								<p>
									단일화된 컴포넌트로 서로 다른 페이지의 slot, props, emit 기반 데이터 값에 따른
									컴포넌트 구성
								</p>
							</li>
						</ul>
					...
					<li>
						...
						<ul className="listStyle2">
							...
							<li>백엔드 개발과 협의하여 올바른 RESTful API 구조에 맞게 Router 설정에 노력을 기울임</li>
							<li>
