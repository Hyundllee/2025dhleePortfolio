	...
	return (
		<div className="modalContent">
			<div className="introText">
				<p>
					기업 관련 분석 보고서, 재무제표, 기업 신용 등 사업자 관련 정보를 손쉽게 검색하고 열람할 수 있도록
					하며, 보고서 구매 서비스를 일원화하여 제공합니다. 최신 UI/UX 트렌드를 반영한 웹사이트를 구축함으로써
					사용자의 구매 경험을 향상시키고, 이를 통해 가치를 창출하여 클라이언트에게 효과적인 서비스를 제공하는
					것을 목표로 합니다.
				</p>
			</div>
				...
				<ul className="listStyle1">
					<li>
						...
						<ul className="listStyle2">
							...
							<li>
								<p>
									Quasar 기본 컴포넌트(q-btn, q-radio, q-input 등)는 국내(K-WCAG) 접근성 규정에 일부
									미흡한 부분이 있어, 직접 커스텀 컴포넌트를 제작하고 내부 로직을 수정하여 접근성을
									강화시켰습니다.{" "}
								</p>
							</li>
							<li>
								<p>
									Nuxt 3의 SSR + SPA 특성상 페이지 이동 시 스크롤 위치가 유지되는 특성이 있어 접근성
									및 사용자 경험 측면에서 초기 <br /> 포커스 및 스크롤 제어가 필요했습니다.
								</p>
							</li>
						</ul>
					</li>
					<li>
						...
						<ul className="listStyle2">
							<li>
								Vue 3 + Composition API 기반으로 SSR, SSG, CSR, On-demand Revalidation(ISR), Hybrid
								Rendering 등 다양한 렌더링 전략을 유연하게 지원
							</li>
						</ul>
					</li>
					<li>
